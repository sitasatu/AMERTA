...
class StandardLCClass(QgsProcessingAlgorithm):
    ...
    🌍 EN This tool standardizes PL values from a source field to a fixed set of standard classes.
    ...
    3) Check "Only fill when PL is NULL" if you don’t want to overwrite existing values.
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        mapping_norm = {}
        if showui:
            feedback.pushInfo(self.tr('Opening PL mapping dialog…'))
